...
export default function HeroSection() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-20rem)] w-full max-w-5xl mx-auto px-6">
            <motion.h1
                className="mb-12 text-6xl md:text-7xl font-bold tracking-tighter text-gray-900 text-center"
