...
const chatNode = async (state: AgentState) => {
    ...
    return {
        messages: [new AIMessage("AI is disabled in frontend.")],
        commands: [],
    };
};
...
const generateImageNode = async (state: AgentState) => {
    ...
    return {
        messages: [new AIMessage("Image generation disabled in frontend.")],
        commands: [],
    };
};
...
const generateVideoNode = async (state: AgentState) => {
    ...
    return {
        messages: [new AIMessage("Video generation disabled in frontend.")],
        commands: [],
    };
};
